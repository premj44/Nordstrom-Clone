...
document.getElementById("password-control").innerHTML+='<img id="eye-show" src="./icons/eye.png">';
document.getElementById("password-control").addEventListener("click",(e)=>{
    console.log(e);
    e.preventDefault();
    let ele=document.getElementById("pwd");
    let btn=document.getElementById("password-control");
